import re
# to set up a dictionary including all the codons and the corresponding amino acids
...
groups = re.findall(r'[A-Z]{3}', seq)  # to divided the sequence into codons in a list
result = ''  # create an empty result for output
for i in range(0, len(groups)):  # use for loop to translate
